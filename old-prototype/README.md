# Anvora Dental - Practice AI Assistant Demo

A high-fidelity landing page for **Anvora Dental** (based in San Francisco, CA) featuring a fully interactive, lightweight, client-side **Dental AI Practice Assistant** chatbot.
...
*   **Social Proof Proofs:** Testimonials from real clinic owners and managers across San Francisco, CA.
...
| **Location & Parking** | *"Where are you located in San Francisco?"* or *"Is there patient parking?"* | Gives the Main Street address and details the free parking lot behind the clinic. |
